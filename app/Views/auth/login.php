...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .orb-1 { width: 500px; height: 500px; background: rgba(240,180,41,.12); top: -160px; left: -160px; }
    .orb-2 { width: 400px; height: 400px; background: rgba(124,106,247,.10); bottom: -120px; right: -120px; animation-delay: -5s; }
    ...
    .cf-input-wrap:focus-within .cf-icon { color: var(--accent); }
    .cf-input::placeholder { color: var(--muted); opacity: .65; }
    ...
    .cf-check span { font-size: .79rem; color: var(--muted); }
    ...
    .cf-alert.error   { background: rgba(240,82,82,.1);  border: 1px solid rgba(240,82,82,.22);  color: var(--danger); }
    .cf-alert.success { background: rgba(62,207,142,.1); border: 1px solid rgba(62,207,142,.22); color: var(--accent2); }
...
<script>
  ...
  function clearAlert() { $('#alertBox').hide().html(''); }
  ...
  $('#usernameInput').on('input', function () {
    $(this).removeClass('is-error'); $('#usernameError').hide(); clearAlert();
  });
  $('#passwordInput').on('input', function () {
    $(this).removeClass('is-error'); $('#pwdError').hide(); clearAlert();
  });
</script>
</body>
</html>